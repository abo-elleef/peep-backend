class Appointment < ApplicationRecord
  ...
  # @monier invoices
  scope :by_staff_ids, -> (staff_ids){ }#joins(:appointment_services).where(lines: { staff_id: staff_ids })}
  scope :by_service, -> (service_ids){ } #joins(:appointment_services).where(lines: {service_id: service_ids} )}
