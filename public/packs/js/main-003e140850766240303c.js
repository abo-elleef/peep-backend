...
var FullCalendar = function (exports) {
  ...
  */
  ...
  function buildDateEnv(settings) {
    ...
    return new DateEnv(_assign(_assign({
  ...
  */
  ...
  Theme.prototype.iconOverridePrefix = ''; /// <reference types="@fullcalendar/core-vdom" />
  ...
  */
  ...
  function ContentHook(props) {
    return createElement(CustomContentRenderContext.Consumer, null, function (renderId) {
      return createElement(ContentHookInner, _assign({
        renderId: renderId
      }, props));
    });
  }
  ...
  function (_super) {
    ...
    MountHook.prototype.componentDidMount = function () {
      ...
      callback && callback(_assign(_assign({}, this.props.hookProps), {
        el: this.rootEl
      }));
    };
    ...
    ToolbarSection.prototype.renderWidgetGroup = function (widgetGroup) {
      ...
      for (var _i = 0, widgetGroup_1 = widgetGroup; _i < widgetGroup_1.length; _i++) {
        ...
        if (buttonName === 'title') {
          ...
          children.push(createElement("button", _assign({
            disabled: isDisabled,
    ...
    */
    ...
    CalendarContent.prototype.render = function () {
      ...
      return createElement(ViewContextType.Provider, {
        value: viewContext
      }, toolbarConfig.headerToolbar && createElement(Toolbar, _assign({
        ref: this.headerRef,
      ...
      }, this.renderView(props), this.buildAppendContent()), toolbarConfig.footerToolbar && createElement(Toolbar, _assign({
        ref: this.footerRef,
    ...
    CalendarContent.prototype.renderView = function (props) {
      ...
      return createElement(ViewComponent, _assign({}, viewProps));
    };
  ...
  function (_super) {
    ...
    TableDateCell.prototype.render = function () {
      ...
      return createElement(RenderHook, {
        ...
        return createElement("th", _assign({
          ref: rootElRef,
        ...
        }, !dayMeta.isDisabled && createElement("a", _assign({
          ref: innerElRef,
      ...
      _this.handleRenderRequest = function () {
        if (_this.isRendering) {
          ...
          render(createElement(CalendarRoot, {
            ...
            }, createElement(CalendarContent, _assign({
  ...
  */
  ...
  function (_super) {
    ...
    TableCell.prototype.render = function () {
      ...
      return createElement(DayCellRoot, {
        ...
        return createElement("td", _assign({
          ref: rootElRef,
  ...
  function (_super) {
    ...
    TableBlockEvent.prototype.render = function () {
      var props = this.props;
      return createElement(StandardEvent, _assign({}, props, {
  ...
  */
  ...
  function resliceDaySegs(segs, dayDate, colIndex) {
    ...
    for (var _i = 0, segs_2 = segs; _i < segs_2.length; _i++) {
      ...
      if (slicedRange) {
        newSegs.push(_assign(_assign({}, seg), {
          firstCol: colIndex,
          lastCol: colIndex,
          eventRange: {
            def: eventRange.def,
      ...
      if (framePositions) {
        for (var _i = 0, segs_1 = segs; _i < segs_1.length; _i++) {
          ...
          */
          ...
          }, hasListItemDisplay(seg) ? createElement(TableListItemEvent, _assign({
            seg: seg,
            isDragging: isDragging,
            isSelected: instanceId === eventSelection,
            defaultDisplayEventEnd: defaultDisplayEventEnd
          }, getSegMeta(seg, todayRange))) : createElement(TableBlockEvent, _assign({
            seg: seg,
            isDragging: isDragging,
      ...
      if (framePositions) {
        for (var _i = 0, segs_2 = segs; _i < segs_2.length; _i++) {
          ...
          nodes.push(createElement("div", {
            ...
            style: leftRightCss
          }, fillType === 'bg-event' ? createElement(BgEvent, _assign({
            seg: seg
    ...
    function Table() {
      ...
      _this.handleMoreLinkClick = function (arg) {
        ...
        if (!clickOption || clickOption === 'popover') {
          _this.setState({
            morePopoverState: _assign(_assign({}, arg), {
  ...
  */
  ...
  function (_super) {
    ...
    TimeColsSlatsBody.prototype.render = function () {
      ...
      return createElement("tbody", null, props.slatMetas.map(function (slatMeta, i) {
        ...
        }, props.axis && createElement(TimeColsAxisCell, _assign({}, slatMeta)), createElement(RenderHook, {
          hookProps: hookProps,
  ...
  function (_super) {
    ...
    TimeBodyAxis.prototype.render = function () {
      return this.props.slatMetas.map(function (slatMeta) {
        return createElement("tr", {
          key: slatMeta.key
        }, createElement(TimeColsAxisCell, _assign({}, slatMeta)));
      });
    };
  ...
  function (_super) {
    ...
    TimeColEvent.prototype.render = function () {
      ...
      return createElement(StandardEvent, _assign({}, this.props, {
  ...
  function (_super) {
    ...
    TimeCol.prototype.renderPrintFgSegs = function (segs) {
      ...
      return segs.map(function (seg) {
        ...
        }, createElement(TimeColEvent, _assign({
          seg: seg,
          isDragging: false,
          isResizing: false,
          isDateSelecting: false,
    ...
    TimeCol.prototype.renderPositionedFgSegs = function (segs, segIsInvisible, isDragging, isResizing, isDateSelecting) {
      ...
      return segs.map(function (seg) {
        var instanceId = seg.eventRange.instance.instanceId;
        var isMirror = isDragging || isResizing || isDateSelecting;
        var positionCss = isMirror ? _assign({
          left: 0,
          right: 0
    ...
    TimeCol.prototype.computeFgSegPositionCss = function (seg) {
      ...
      return _assign(_assign({}, props), this.computeSegTopBottomCss(seg));
    };
  ...
  function (_super) {
    ...
    DayTimeCols.prototype.render = function () {
      ...
      return createElement(NowTimer, {
        ...
        return createElement(TimeCols, _assign({
  ...
  function (_super) {
    ...
    DayTimeColsView.prototype.render = function () {
      ...
      var allDayContent = options.allDaySlot !== false && function (contentArg) {
        return createElement(DayTable, _assign({}, splitProps['allDay'], {
          dateProfile: dateProfile,
          dayTableModel: dayTableModel,
          nextDayThreshold: options.nextDayThreshold,
          tableMinWidth: contentArg.tableMinWidth,
      ...
      var timeGridContent = function timeGridContent(contentArg) {
        return createElement(DayTimeCols, _assign({}, splitProps['timed'], {
          dayTableModel: dayTableModel,
          dateProfile: dateProfile,
  ...
  function renderInnerContent$4(props) {
    ...
    return createElement(Fragment, null, props.text && createElement("a", _assign({
      className: 'fc-list-day-text'
    }, navLinkAttrs), props.text), props.sideText && createElement("a", _assign({
  ...
  function renderEventInnerContent(props) {
    ...
    return createElement("a", _assign({}, anchorAttrs), event.title);
  }
  ...
  */
        ...
        for (var dayIndex = 0; dayIndex < segsByDay.length; dayIndex++) {
          ...
          if (daySegs) {
            ...
            for (var _i = 0, daySegs_1 = daySegs; _i < daySegs_1.length; _i++) {
              ...
              innerNodes.push(createElement(ListViewEventRow, _assign({
  ...
  function buildRequestParams$1(range, apiKey, extraParams, dateEnv) {
    ...
    params = _assign(_assign({}, extraParams || {}), {
      key: apiKey,
      timeMin: startStr,
      timeMax: endStr,
      singleEvents: true,
...
/******/ });
//# sourceMappingURL=main-003e140850766240303c.js.map