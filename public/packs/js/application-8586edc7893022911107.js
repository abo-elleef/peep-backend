...
__webpack_require__(/*! packs/main.min.js */ "./app/javascript/packs/main.min.js"); // Uncomment to copy all static images under ../images to the output folder and reference
  ...
  var fo = function (e) {
    ...
    return n(t, e), t.prototype.render = function () {
      ...
      if (void 0 === r && (r = mo(t.defaultContent, t.hookProps)), void 0 !== r) {
        if (n) n.contentVal = r[n.contentKey];else if ("object" == typeof r) for (var i in e) {
          if (void 0 !== r[i]) {
            n = this.customContentInfo = {
              contentKey: i,
              contentVal: r[i],
...
/******/ });
//# sourceMappingURL=application-8586edc7893022911107.js.map